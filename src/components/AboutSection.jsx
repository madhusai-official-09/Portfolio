...
export const AboutSection = () => {
    ...
    <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
         ...
         <a href="https://drive.google.com/file/d/1MUKTT_Wv0oEjcjiLfmrZYLrYPX0Gqpwd/view?usp=drive_link" className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300">
          {" "}
          Download CV
            </a>
                </div>
